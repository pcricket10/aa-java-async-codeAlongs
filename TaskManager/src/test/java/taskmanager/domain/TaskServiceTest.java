...
class TaskServiceTest {
    ...
    public void shouldCreateTask() throws DataAccessException {
        ...
        assertNotNull(actual.getTask()); // verify that the payload is set
    ...
    public void shouldNotCreateTaskWithTitleLongerThan50Char() throws DataAccessException {
        TaskResult actual = service.create(new Task(0, "2023-05-09", "prepare apple slices and snack for soccer game longer than 50 characters testing testing testing testing testing", "prepare apple slices and snack for soccer game", "2023-05-11", Status.COMPLETE));
        assertFalse(actual.isSuccess());
        assertNull(actual.getTask());
        assertEquals("Title must exist and cannot be longer than 50 characters", actual.getMessages().get(0));
    }
    ...
    public void shouldNotCreateTaskWithDescriptionLessThan20Char() throws DataAccessException {
        TaskResult actual = service.create(new Task(0, "2023-05-09", "Prepare Snacks", "Test", "2023-05-11", Status.COMPLETE));
        assertFalse(actual.isSuccess());
        assertNull(actual.getTask());
    ...
    @Test
    public void shouldFindExistingIt() throws DataAccessException {
    ...
    public void shouldNotFindNonExistingId() throws DataAccessException {
        Task actual = service.findById(99999);
        assertNull(actual);
    }
    // UPDATE
    @Test
